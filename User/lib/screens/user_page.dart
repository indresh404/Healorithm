...
import 'package:healorithm/components/user/alert_section.dart';
import 'package:healorithm/components/user/records_section.dart';
import 'package:healorithm/components/user/profile_section.dart';
import 'package:healorithm/components/user/ai_chat_screen.dart';
import 'package:healorithm/components/user/home_screen.dart';
...
class _UserPageState extends State<UserPage> with TickerProviderStateMixin {
  ...
  static const _navItems = [
    _NavItem(Icons.home_rounded,                Icons.home_outlined,               'Place'),
    _NavItem(Icons.notifications_active_rounded, Icons.notifications_none_rounded,  'Meds'),
    _NavItem(Icons.bolt_rounded,                Icons.bolt_outlined,               'Records'),
  ...
  void _startLoadingTicker() {
    // Rotating loading status messages for the Home tab.
  ...
  Widget _buildPageBody() {
    final screens = [
      const HomeScreen(),       // Home tab shows nearest hospitals
      const AlertSection(),
      const UpdateSection(),
    ...
    return AnimatedSwitcher(
      ...
      child: KeyedSubtree(
          key: ValueKey(_selectedIndex), child: screens[_selectedIndex]),
    );
  }
                  ...
                  builder: (_, __) => Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                            color: Colors.white
                                .withOpacity(0.7 * pulseAnim.value),
                            blurRadius: 4)
                      ],
                    ),
                  ),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(
          ...
          children: [
            _Bar(day: 'Mon', factor: 0.80, color: AppTheme.primaryBlue),
            _Bar(day: 'Tue', factor: 0.60, color: AppTheme.accentBlue),
            _Bar(day: 'Wed', factor: 0.92, color: AppTheme.primaryBlue),
            _Bar(day: 'Thu', factor: 0.50, color: AppTheme.skyBlue),
            _Bar(day: 'Fri', factor: 0.70, color: AppTheme.accentBlue),
...
class _StatTile extends StatelessWidget {
  final Color color;
  final String label, count, trend;
  const _StatTile(
      {required this.color,
        required this.label,
        required this.count,
...
class _Bar extends StatelessWidget {
  ...
  final Color color;
  const _Bar(
      {required this.day, required this.factor, required this.color});
...
class _NavItem {
  final IconData filledIcon, outlinedIcon;
  final String label;
